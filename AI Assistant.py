	...
	def assistant(self):
		...
		while True:
			...
			if (("run" in p) or ("execute" in p) or ("open" in p)) and (("Chrome" in p) or ("browser" in p)):
				...
				pyttsx3.speak("your name is Yash Sharma and you have a short temper personality")
			elif (("can" in p) or ("tell" in p)) and (("name" in p) or ("about" in p)): 
				pyttsx3.speak("your name is Yash Sharma and you are the person who created me ")
